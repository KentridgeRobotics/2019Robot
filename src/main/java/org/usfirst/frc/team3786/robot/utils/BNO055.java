...
public class BNO055 {
	...
	private volatile byte[] positionVectorMag = new byte[6];
	private volatile long turnsMag = 0;
	private volatile double[] xyzMag = new double[3];
	private volatile byte[] positionVectorGyro = new byte[6];
	private volatile long turnsGyro = 0;
	private volatile double[] xyzGyro = new double[3];
	private volatile byte[] positionVectorAccel = new byte[6];
	private volatile long turnsAccel = 0;
	private volatile double[] xyzAccel = new double[3];
	private volatile byte[] positionVectorLinAccel = new byte[6];
	private volatile long turnsLinAccel = 0;
	private volatile double[] xyzLinAccel = new double[3];
	private volatile byte[] positionVectorEuler = new byte[6];
	private volatile long turnsEuler = 0;
	private volatile double[] xyzEuler = new double[3];
	private volatile byte[] positionVectorGrav = new byte[6];
	private volatile long turnsGrav = 0;
	private volatile double[] xyzGrav = new double[3];
	...
	public enum opmode_t {
		...
		OPERATION_MODE_GYRONLY(0X03, false, false, true, false), OPERATION_MODE_ACCMAG(0X04, true, true, false, false),
		OPERATION_MODE_ACCGYRO(0X05, true, false, true, false), OPERATION_MODE_MAGGYRO(0X06, false, true, true, false),
		OPERATION_MODE_AMG(0X07, true, true, true, false), OPERATION_MODE_IMUPLUS(0X08, true, false, true, false),
		OPERATION_MODE_COMPASS(0X09, true, true, false, false), OPERATION_MODE_M4G(0X0A, true, true, false, false),
		OPERATION_MODE_NDOF_FMC_OFF(0X0B, true, true, true, true), OPERATION_MODE_NDOF(0X0C, true, true, true, true);
	...
	private void calculateVector() {
		double[] posMag = new double[3];
		double[] posGyro = new double[3];
		double[] posAccel = new double[3];
		double[] posLinAccel = new double[3];
		double[] posEuler = new double[3];
		double[] posGrav = new double[3];
		short xMag = 0, yMag = 0, zMag = 0;
		short xGyro = 0, yGyro = 0, zGyro = 0;
		short xAccel = 0, yAccel = 0, zAccel = 0;
		short xLinAccel = 0, yLinAccel = 0, zLinAccel = 0;
		short xEuler = 0, yEuler = 0, zEuler = 0;
		short xGrav = 0, yGrav = 0, zGrav = 0;
		double headingDiffMag = 0.0;
		double headingDiffGyro = 0.0;
		double headingDiffAccel = 0.0;
		double headingDiffLinAccel = 0.0;
		double headingDiffEuler = 0.0;
		double headingDiffGrav = 0.0;
		...
		if (opmode.isMag()) {
			...
			xMag = (short) ((positionVectorMag[0] & 0xFF) | ((positionVectorMag[1] << 8) & 0xFF00));
			yMag = (short) ((positionVectorMag[2] & 0xFF) | ((positionVectorMag[3] << 8) & 0xFF00));
			zMag = (short) ((positionVectorMag[4] & 0xFF) | ((positionVectorMag[5] << 8) & 0xFF00));
			/* 1uT = 16 LSB */
		...
		if (opmode.isGyro()) {
			...
			xGyro = (short) ((positionVectorGyro[0] & 0xFF) | ((positionVectorGyro[1] << 8) & 0xFF00));
			yGyro = (short) ((positionVectorGyro[2] & 0xFF) | ((positionVectorGyro[3] << 8) & 0xFF00));
			zGyro = (short) ((positionVectorGyro[4] & 0xFF) | ((positionVectorGyro[5] << 8) & 0xFF00));
			/* 1rps = 900 LSB */
		...
		if (opmode.isAccel()) {
			...
			xAccel = (short) ((positionVectorAccel[0] & 0xFF) | ((positionVectorAccel[1] << 8) & 0xFF00));
			yAccel = (short) ((positionVectorAccel[2] & 0xFF) | ((positionVectorAccel[3] << 8) & 0xFF00));
			zAccel = (short) ((positionVectorAccel[4] & 0xFF) | ((positionVectorAccel[5] << 8) & 0xFF00));
			/* 1m/s^2 = 100 LSB */
		...
		if (opmode.isFusion()) {
			...
			xLinAccel = (short) ((positionVectorLinAccel[0] & 0xFF) | ((positionVectorLinAccel[1] << 8) & 0xFF00));
			yLinAccel = (short) ((positionVectorLinAccel[2] & 0xFF) | ((positionVectorLinAccel[3] << 8) & 0xFF00));
			zLinAccel = (short) ((positionVectorLinAccel[4] & 0xFF) | ((positionVectorLinAccel[5] << 8) & 0xFF00));
			/* 1m/s^2 = 100 LSB */
		...
		if (opmode.isFusion()) {
			...
			xEuler = (short) ((positionVectorEuler[0] & 0xFF) | ((positionVectorEuler[1] << 8) & 0xFF00));
			yEuler = (short) ((positionVectorEuler[2] & 0xFF) | ((positionVectorEuler[3] << 8) & 0xFF00));
			zEuler = (short) ((positionVectorEuler[4] & 0xFF) | ((positionVectorEuler[5] << 8) & 0xFF00));
			/* 1 degree = 16 LSB */
		...
		if (opmode.isFusion()) {
			...
			xGrav = (short) ((positionVectorGrav[0] & 0xFF) | ((positionVectorGrav[1] << 8) & 0xFF00));
			yGrav = (short) ((positionVectorGrav[2] & 0xFF) | ((positionVectorGrav[3] << 8) & 0xFF00));
			zGrav = (short) ((positionVectorGrav[4] & 0xFF) | ((positionVectorGrav[5] << 8) & 0xFF00));
			/* 1m/s^2 = 100 LSB */
	 ...
	 * @return a vector [heading, roll, pitch]
	 */
	public double[] getVectorLinAccel() {
		return xyzLinAccel;
	}
	...
	public double getHeadingGyro() {
		return xyzGyro[0] + turnsGyro * 360;
	}
	...
	public double getHeadingAccel() {
		return xyzAccel[0] + turnsAccel * 360;
	}
	 ...
	 * @return heading in degrees
	 */
	public double getHeadingLinAccel() {
		return xyzLinAccel[0] + turnsLinAccel * 360;
	}
	 ...
	 * @return heading in degrees
	 */
	public double getHeadingEuler() {
		return xyzEuler[0] + turnsEuler * 360;
	}
	 ...
	 * @return heading in degrees
	 */
	public double getHeadingGrav() {
		return xyzGrav[0] + turnsGrav * 360;
	}
